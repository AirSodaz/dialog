...
const DocumentListItem = React.memo(({
    ...
    return (
        ...
        >
            <button
                className="absolute inset-0 w-full h-full z-0 bg-transparent cursor-pointer rounded-lg focus-visible:ring-2 focus-visible:ring-stone-400 dark:focus-visible:ring-stone-600 outline-none"
                onClick={() => onOpen(id)}
            ...
            <div className="relative z-20 flex items-center gap-1 opacity-0 group-hover:opacity-100 group-focus-within:opacity-100 transition-opacity">
                {viewType === 'trash' ? (
                    <>
                        <button
